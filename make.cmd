...
popd
pushd bin\v4Release
IronPythonTest.exe --labels=All --where:Category==StandardCPython --result:smoke-net40-release-result.xml
popd
goto :exit
...
popd
pushd bin\v4Debug
IronPythonTest.exe --labels=All --where:Category==IronPython --result:ironpython-net40-debug-result.xml
popd
goto :exit
...
popd
pushd bin\v4Release
IronPythonTest.exe --labels=All --result:all-net40-release-result.xml
popd
goto :exit
