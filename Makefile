...
test-all-release:
	(cd bin/Release && mono ./IronPythonTest.exe --labels=All --result=all-result-net45.xml) || true
	(cd bin/v4Release && mono ./IronPythonTest.exe --labels=All --result=all-result-net40.xml) || true
