...
class ConditionalTest(unittest.TestCase):
    ...
    def test_cp13299(self):
        ...
        self.assertEqual(3.14 if True else 1L, 3.14)
        self.assertEqual(3.14 if True else -1, 3.14)
        ...
        self.assertEqual(3.14 if True else 0L, 3.14)
        ...
        self.assertEqual(3.14 if True else [[1]], 3.14)
        self.assertEqual(3.14 if True else u"", 3.14)
        
        self.assertEqual(1 if False else 3.14, 3.14)
        self.assertEqual(1L if False else 3.14, 3.14)
        self.assertEqual(-1 if False else 3.14, 3.14)
        ...
        self.assertEqual(0L if False else 3.14, 3.14)
        ...
        self.assertEqual([[1]] if False else 3.14, 3.14)
        self.assertEqual(u"" if False else 3.14, 3.14)
