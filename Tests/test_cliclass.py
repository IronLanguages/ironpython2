...
import sys
import unittest
from iptest import IronPythonTestCase, skipUnlessIronPython, is_cli, is_netcoreapp, is_mono, run_test
...
End Class""")
    ...
    def test_dict_copy(self):
        self.assertTrue(int.__dict__.copy().has_key('MaxValue'))
...
"""
    ...
    def test_cp24004(self):
        self.assertTrue(System.Array.__dict__.has_key("Find"))
