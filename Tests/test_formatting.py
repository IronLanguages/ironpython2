...
class FormattingTest(IronPythonTestCase):
    def test_floats(self):
        ...
        if is_cli and not (is_netcoreapp and not is_netcoreapp21): # https://github.com/IronLanguages/ironpython2/issues/634
    ...
    def test_unicode(self):
        ...
        self.assertEqual("%c" % unicode('x'), unicode('x'))
        try:
            self.assertEqual("%c" % 65535, u'\uffff')
    ...
    def test_named_inputs(self):
        ...
        self.assertEqual(repr(u"\u00F4"), "u'\\xf4'")
        self.assertEqual(repr(u"\u10F4"), "u'\\u10f4'")
