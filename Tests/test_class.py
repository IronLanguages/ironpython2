...
class ClassTest(IronPythonTestCase):
    ...
    def test_type_in(self):
        self.assertEqual(type in (None, True, False, 1, {}, [], (), 1.0, 1L, (1+0j)), False)
...
# use exec to define methods on classes:
    ...
    def test_check_dictionary(self):
        ...
        def CheckDictionary(C):
            ...
            if object in C.__bases__:
                ...
                self.assertEqual(C.__dict__.has_key(2), False)
    ...
    def test_slots(self):
        ...
        x = a.__dict__
        self.assertEqual(x.has_key('abc'), False)
        a.xyz = 'abc'
    ...
    def test_outer_scope(self):
        ...
        def outer_scope_test():
            ...
            class C:
                if Referenced: pass
            self.assertTrue("Referenced" not in C.__dict__.keys())
    ...
    def test_dictproxy_access(self):
        ...
        self.assertEqual(set(KNew.__dict__.iteritems()), set(dict(KNew.__dict__).iteritems()))
        self.assertEqual(set(KNew.__dict__.iterkeys()), set(dict(KNew.__dict__).iterkeys()))
        self.assertEqual(set(KNew.__dict__.itervalues()), set(dict(KNew.__dict__).itervalues()))
...
## __int__
    ...
    def test_method_tuple_type(self):
        ...
        self.assertRaises(TypeError, type(x.f)(f, None, (int, str)), 1L)
