...
class BuiltinsTest2(IronPythonTestCase):
    ...
    def test_callable_oldclass(self):
        ...
        self.assertEqual(callable(d), True) # True for oldinstance, False for new classes.
        #
    ...
    def test_sorted(self):
        ...
        self.assertTrue(sorted(range(10), None, None, True) == range(10)[::-1])
        self.assertTrue(sorted(range(9,-1,-1), None, None, False) == range(10))
        self.assertTrue(sorted(range(10), invcmp, None, True) == sorted(range(9,-1,-1), None, None, False))
        self.assertTrue(sorted(range(9,-1,-1),invcmp, None, True) == sorted(range(9,-1,-1), None, None, False))
    ...
    def test_zip(self):
        ...
        self.assertEqual(zip(foo()), [(2,)])
        self.assertEqual(zip(foo(), foo()), [(2,2)])
        self.assertEqual(zip(foo(), foo(), foo()), [(2,2,2)])
        ...
        self.assertEqual(zip(*[xrange(3)] * 2), [(0, 0), (1, 1), (2, 2)])
        self.assertEqual(zip(*[iter(["0", "1"])] * 2), [('0', '1')])
        self.assertEqual(zip(*[iter(["0", "1", "2"])] * 3), [('0', '1', '2')])
        self.assertEqual(zip(*'abc'), [('a', 'b', 'c')])
